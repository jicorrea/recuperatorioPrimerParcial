...
if(isset($_SESSION['registrado']))
{
	...
	$arrayDeCds=usuario::TraerTodoLosUsuarios();
...
foreach ($arrayDeCds as $cd) {
	echo"<tr>
			...
			<td><a onclick='BorrarCD($cd->id)' class='btn btn-danger' style='visibility: hidden;'>   <span class='glyphicon glyphicon-trash'>&nbsp;</span>  Borrar</a></td>
			<td>$cd->cantante</td>
			<td>$cd->titulo</td>
			<td>$cd->año</td>
		</tr>   ";
