	...
	<header id="header">
		...
		<nav>
			<ul id="main-nav" class="clearfix">
				<li><a onclick="MostarLogin()" class="btn">Ingresar</a></li>
				<li><a onclick="MostrarRegistrar()" id="perfil" class="btn">Registrarse</a> </li>
				<li><a onclick="" class="btn" id="perfil">----</a> </li>
